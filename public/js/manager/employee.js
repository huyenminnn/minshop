$(document).ready(function () {
	...
	$('#form-add').submit(function(e){
		...
		data.append('salary',$('#salary-add').val())
		data.append('branch',$('#branch-add').val())
		$.ajax({
			type: "post",
			url: '/admin/employee',
			data: data,
	        ...
	        success: function(data, textStatus, jqXHR) {
	        	...
	        	toastr.success('Add employee success!')
	...
	$('body').on('click','.btn-edit', function(){
		...
		$.ajax({
			...
			success: function (response){
				...
				$('#branch-edit').val(response.branch)
				$('#salary-edit').val(response.salary)
				$('#email-edit').val(response.email)
				// $('#avatar-edit').val(response.avatar)
	...
	$('#form-edit').submit(function(e){
		...
		data.append('salary',$('#salary-edit').val())
		data.append('branch',$('#branch-edit').val())
		$.ajax({
			type: 'post',
			url: '/admin/employee_edit/' + id,
			data: data,
			processData: false,
			contentType: false,
			success: function (response){
				toastr.success('Update employee success!')
				setTimeout(function () {
