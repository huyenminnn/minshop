            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                {{-- <li><a href="/"><i class="fa fa-home"></i> Dashboard <span class="fa fa-chevron-down"></span></a> --}}
                  ...
                  {{-- </li> --}}
                  <li><a href="/admin/user"><i class="fa fa-users"></i> Users {{-- <span class="fa fa-chevron-down"></span> --}}</a>
                    <li><a href="/admin/product"><i class="fa fa-edit"></i> Products {{-- <span class="fa fa-chevron-down"></span> --}}</a>
                    {{-- <ul class="nav child_menu">
                  ...
                  <li><a href="#"><i class="fa fa-sticky-note"></i> Orders  <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a href="#"><i class="fa fa-desktop"></i> Option <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/admin/option">Option</a></li>
                      <li><a href="/admin/option-value">Detail Option</a></li>
                    </ul>
                  </li>
